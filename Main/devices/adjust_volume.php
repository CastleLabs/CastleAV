...
function adjustVolume() {
    ...
    return [
        'success' => $allSuccess,
        'message' => $allSuccess ? 'Volume adjusted successfully for all devices' : 'Some devices failed to adjust volume',
        'details' => $responses
    ];
}
...
try {
    ...
    error_log("Unexpected error in adjustVolume: " . $e->getMessage());
    echo json_encode([
        'success' => false,
